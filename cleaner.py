...
Word.delete().where(Word.word2 == "PM").execute()
Word.delete().where(Word.word2 == "AM").execute()
Word.delete().where(Word.word2 == "،").execute()
Word.delete().where(Word.word2 == ":").execute()
Word.delete().where(Word.word2 == "«").execute()
Word.delete().where(Word.word2 == "»").execute()
Word.delete().where(Word.word2 == "(").execute()
...
Word.delete().where(Word.word2 == "؛").execute()
Word.delete().where(Word.word2 == "؟").execute()
Word.delete().where(Word.word2 == "%htmlDTD;").execute()
Word.delete().where(Word.word2 == "%feedDTD;").execute()
Word.delete().where(Word.word2 == ";").execute()
Word.delete().where(Word.word2.contains("2015")).execute()
Word.delete().where(Word.word2.contains("/")).execute()
db.close()
